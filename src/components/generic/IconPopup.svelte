<!-- Iconpopup.svelte
A clickable icon badge that triggers a popup.
-->
<script>
	...
	const classesToApply = ['rounded-full p-2 ring-2 text-white'];
</script>
...
/>
<Popup {showPopup} on:popupClosed>
	<!-- Provide ability for programmer (me!) to fill out content -->
