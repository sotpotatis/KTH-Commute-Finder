...
<h1 class="text-4xl font-bold">{buildingName}:
    ...
    {#if editing}
        ...
        <input name="newTime" class="bg-gray-900 w-24 hover:ring-blue-400 ring-2 hover:cursor-pointer px-3"
        type="number" min="0" value={currentWalkTime}
        />
    ...
    {:else}
        ...
        <IconButton iconName="mdi:edit" on:click={()=>{
            editing = true
        }}/>
    {/if}
    promenad
